...
def main():
    ...
    parser.add_argument(
        "--model", type=str, default="train_model/16b_1280_origin_yolov8/best.pt", help="模型路径，例如：yolo11n.pt"
    )
    ...
    while cap.isOpened():
        ...
        # 添加FPS信息
        cv2.putText(original_frame, f"FPS: {current_fps:.1f}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0), 2)
