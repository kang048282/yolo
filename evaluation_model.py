...
def evaluate_model():
    ...
    # 使用自定义数据集进行评估
    results = model.val(data="cross4.yaml",project='validation_results',name='64b_640_C3TR_yolov11n',save_txt=True,save_json=True, plots=True)
    ...
    class_map = {i: name for i, name in class_names.items()}
